...
\input{packages_and_settings_biber.tex} %加载各宏包以及本模板的主要设置
...
\phantomsection
\input{body/variationalprin.tex} %正文第一章
\printbibliography[heading=subbibliography, title={参考文献}, section=\therefsection]
\cleardoublepage
...
\phantomsection
\input{body/linearelasticity.tex}
\printbibliography[heading=subbibliography, title={参考文献}, section=\therefsection]
\cleardoublepage

\phantomsection
\input{body/biharmonicperturb.tex}
\printbibliography[heading=subbibliography, title={参考文献}, section=\therefsection]
\cleardoublepage
