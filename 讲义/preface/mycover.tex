...
\begin{titlepage}
	...
	\begin{center}
% \noindent \bfseries \zihao{4}{\rmfamily{\CompleteYear 届本科生学士学位论文\hfill 学校代码：\uline{10269}}}
\end{center}
	...
	% \begin{textblock}{146.4}(31.8,100)
	% 	\setstretch{2.0}
	% 	\begin{center}
	% 			\noindent\textbf{\zihao{1}{\rmfamily{有限差分法与有限元法}}}
	% 		\end{center}
			
	% \end{textblock}

	\begin{textblock}{146.4}(31.8,75)
		\setstretch{2.0}
		\noindent
		\begin{minipage}[t][8.2cm][c]{\linewidth}
			\begin{center}
				\noindent\textbf{\zihao{1}{\rmfamily{混合有限元方法}}}
			\end{center}
			\begin{center}
				\noindent\zihao{2}{\rmfamily{黄学海}}
			\end{center}
		\end{minipage}
	\end{textblock}
