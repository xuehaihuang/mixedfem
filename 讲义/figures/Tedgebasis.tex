...
\path let \p1 = (P1), \p2 = (P4) in
    coordinate (m14) at ($(\x1,\y1)!0.5!(\x2,\y2)$); 

\path (m14) ++(0.2, -0.4, -0.02) coordinate (endn2);
\path (m14) ++(0.15, 0, -0.315) coordinate (endn3);
...
\draw[thick, ->, >=stealth] (m14) -- (endn2);
\draw[thick, ->, >=stealth] (m14) -- (endn3);
\node[right] at (endn2) {$\boldsymbol n^{\{0,1\}}_{\{0,1,2\}}$};
\node[below] at (endn3) {$\boldsymbol n^{\{0,1\}}_{\{0,1,3\}}$};
...
\draw[thick, dashed] (0.175,0.175,0) -- (0.175,0.175,-0.135); %n3
\draw[thick,->,>=stealth] (0.175,0.175,-0.135) -- (0.175,0.175,-0.35); %n3
% \draw[thick,->] (-0.25,0,0.425) -- (-0.25,0.55,0.55); %n1
